...
4. Copy API_CREDENTIALS.ini to Amibroker folder, this has the following content :
	[Config]
	Endpoint="https://mynt.in/NorenClientTP/"
	ApiSecret=
	VendorCode= 
	IMEI=
	MAC=
...
NorenApi.afl provides a basic framework for Entry and Exit Signals on the last candle. 
